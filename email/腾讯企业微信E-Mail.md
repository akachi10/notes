...
```java
package com.rainbowfish.geographicreportsystem.service;
...
public class GetTxEmailTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        store.connect("pop.exmail.qq.com", "xx.xx@rainbowfish11000.com", "xxx!");
        //            网易邮箱的服务器地址   账号  密码
